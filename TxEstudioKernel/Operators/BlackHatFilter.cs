...
{
    [DigitalFilter]
    [Algorithm("Black Hat Filter", "Perform advanced morphological transformations using erosion and dilation as basic operations")]
    [Abbreviation("blackhat", "Window", "Iterations")]
    public class BlackHatFilter : TxOneBand
    {
        ...
        public override TxImage Process(TxImage input)
        {
            ...
            CV.cvMorphologyEx(input.InnerImage, result.InnerImage, IntPtr.Zero, kernel.InnerKernel, 6, iterations);
