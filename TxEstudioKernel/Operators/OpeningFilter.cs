...
{
    [DigitalFilter]
    [Algorithm("Opening Morphological Filter", "Perform advanced morphological transformations using erosion and dilation as basic operations")]
    [Abbreviation("opening", "Window", "Iterations")]
    public class OpeningFilter : TxOneBand
    {
        ...
        public override TxImage Process(TxImage input)
        {
            ...
            CV.cvMorphologyEx(input.InnerImage, result.InnerImage, IntPtr.Zero, kernel.InnerKernel, 2, iterations);
