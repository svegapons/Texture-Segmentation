...
{
    [Algorithm("OR", "Computes the OR operator between the given images")]
    [Abbreviation("OR")]
    public class OrOperator:TxMultiBand
    {
        public override TxImage Process(params TxImage[] images)
        {
            ...
            CXCore.cvOr(tx1.InnerImage, tx2.InnerImage, result.InnerImage, IntPtr.Zero);
            return result;
        }
    }
}
