...
{
    [DigitalFilter]
    [Algorithm("Top Hat Gradient Filter", "Perform advanced morphological transformations using erosion and dilation as basic operations")]
    [Abbreviation("tophat", "Window", "Iterations")]
    public class TopHatFilter : TxOneBand
    {
        ...
        public override TxImage Process(TxImage input)
        {
            ...
            CV.cvMorphologyEx(input.InnerImage, result.InnerImage, IntPtr.Zero, kernel.InnerKernel, 5, iterations);
